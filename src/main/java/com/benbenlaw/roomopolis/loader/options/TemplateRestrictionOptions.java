...
public record TemplateRestrictionOptions(boolean sideOnlyPlacement, boolean topOnlyPlacement, boolean blocksRequired, boolean overrideExistingBlocks, boolean replaceWaterLoggedBlocks) {

    public static final Codec<TemplateRestrictionOptions> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            Codec.BOOL.optionalFieldOf("side_only_placement", false).forGetter(TemplateRestrictionOptions::sideOnlyPlacement),
            Codec.BOOL.optionalFieldOf("top_only_placement", false).forGetter(TemplateRestrictionOptions::topOnlyPlacement),
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, TemplateRestrictionOptions> STREAM_CODEC = StreamCodec.composite(
            ByteBufCodecs.BOOL, TemplateRestrictionOptions::sideOnlyPlacement,
            ByteBufCodecs.BOOL, TemplateRestrictionOptions::topOnlyPlacement,
