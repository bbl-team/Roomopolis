...
public class RoomopolisItems {
    ...
    public static final DeferredItem<Item> TINY_ROOM_KEY = ITEMS.register("tiny_room_key",
            () -> new KeyItem(new Item.Properties(), "roomopolis:tiny_room", 0, 0, "roomopolis:room_key_block", true, true, true, false));
    public static final DeferredItem<Item> SMALL_ROOM_KEY = ITEMS.register("small_room_key",
            () -> new KeyItem(new Item.Properties(),"roomopolis:small_room", 0, 0, "roomopolis:room_key_block", true, true, true, false));
    public static final DeferredItem<Item> MEDIUM_ROOM_KEY = ITEMS.register("medium_room_key",
            () -> new KeyItem(new Item.Properties(), "roomopolis:medium_room", 1, 0,"roomopolis:room_key_block", true, true, true, false));
    public static final DeferredItem<Item> LARGE_ROOM_KEY = ITEMS.register("large_room_key",
            () -> new KeyItem(new Item.Properties(), "roomopolis:large_room", 2, 0, "roomopolis:room_key_block", true, true, true, false));;
